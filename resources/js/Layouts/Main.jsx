            ...
            <div className="z-20 w-64 my-3 ms-3 overflow-y-auto overflow-clip scroll-wrapper">
                <aside className="bg-white dark:bg-gray-900 md:block flex-shrink-0 shadow-sm rounded-lg">
                    <div className="py-4 text-gray-500 dark:text-gray-400">
                        <a className="flex gap-2 items-center justify-center dark:border-b-gray-700 pb-2 mx-4 text-xl font-medium text-gray-800 dark:text-gray-200 mb-4"
                           href="/">
                            <Icon name="stack"/>
                        ...
                        <ul>
                            ...
                            <li className="relative px-6 py-2">
                                <NavItem active={url.startsWith('/categories')} icon={'task'}
                                         href={route('categories.index')}>
                                    Categories
                                </NavItem>
                            </li>
                            <li className="relative px-6 py-2">
                                <NavItem active={url.startsWith('/schedules')} icon={'calendar'}
